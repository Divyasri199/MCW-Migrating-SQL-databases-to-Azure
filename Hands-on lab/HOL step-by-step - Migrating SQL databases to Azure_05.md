...
1. Select the hands-on-lab-<inject key="DeploymentID" /> resource group from the list.
...
1. In the list of resources for your resource group, select the Sql2008-<inject key="DeploymentID" />.
...
1. On the Sql2008-<inject key="DeploymentID" /> blade in the Azure portal, select **Overview** from the left-hand menu, and then select **Connect** and **RDP** on the top menu, as you've done previously.
...
6. On the **Sources** screen, enter the following into the **Connect to a server** dialog that appears on the right-hand side:
   ...
   - **Server name**: Enter **SQL2008-<inject key="DeploymentID" />**.
...
5. On the **Sources** screen, enter the following into the **Connect to a server** dialog that appears on the right-hand side:
   ...
   - **Server name**: Enter **SQL2008-SUFFIX**.
   - **Authentication type**: Select **SQL Server Authentication**.
   - **Username**: Enter `WorkshopUser`
   - **Password**: Enter `Password.1234567890`
   - **Encrypt connection**: Check this box.
