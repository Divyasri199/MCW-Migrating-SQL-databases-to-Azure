...
1. In the list of resources for your resource group, select the Sql2008-<inject key="DeploymentID" /> VM.
...
1. On the Sql2008-<inject key="DeploymentID" /> VM blade in the Azure portal, select **Overview** from the left-hand menu, and then select **Connect** and **RDP** on the top menu, as you've done previously.
